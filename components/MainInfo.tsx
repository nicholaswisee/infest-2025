    ...
    <section>
      <div className="relative h-full w-full isolate overflow-hidden">
        ...
        <div className="p-10 md:p-16 lg:p-20 lg:px-32">
          <h1 className="text-white font-bold text-3xl md:text-5xl lg:text-6xl mt-20">
            What is{" "}
          ...
          <div className="grid lg:grid-cols-2 mt-5 gap-7">
            <p className="text-xs md:text-sm lg:text-base flex items-center text-white/90 leading-relaxed text-shadow-lg/20 p-6 relative bg-gradient-to-bl from-[#996ACD] to-[#491C7C] rounded-2xl border border-white/20">
              <span>
                {" "}
            ...
            <p className="text-xs md:text-sm lg:text-base flex items-center text-white/90 leading-relaxed text-shadow-lg/20 p-6 relative bg-gradient-to-bl from-[#C18EFC] to-[#782DCD] rounded-2xl border border-white/20">
              <span>
                {" "}
          ...
          <h1 className="mb-8 mt-16 md:mt-24 lg:mt-30 text-3xl md:text-5xl lg:text-6xl w-fit font-bold text-white mx-auto bg-gradient-to-b from-purple-900/70 to-fuchsia-800/70 rounded-full shadow-[inset_0px_10px_18.799999237060547px_0px_rgba(166,143,194,1.00)] px-4 py-2 sm:py-3 md:px-6 items-center">
            Our{" "}
            <span className="bg-gradient-to-b from-white via-[#C899FF] to-white text-transparent bg-clip-text">
              Events
            </span>
